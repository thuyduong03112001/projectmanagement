                    ...
                    <div class="main-wrapper">
                        <div class="row">
                            <div class="col-xl">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Approve Timesheet</h5>
                                        <form action="timesheetadd" method="Post" class="needs-validation" novalidate >
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="Duration" placeholder="Duration" value="" name="duration" required>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="WorkResult" placeholder="WorkResult" value="" name="workResult" required>
                                                    <div class="invalid-feedback">
