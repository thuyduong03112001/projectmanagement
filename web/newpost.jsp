                                    ...
                                    <div class="card text-center">
                                        <form action="newpost" method="post" enctype="multipart/form-data">
                                            <div class="btn btn-primary btn-lg btn-block" style=" line-height: initial; font-size: 2em; padding: 2%; ">
                                                <input required="" style="background: transparent;width: 100%;text-align: center;border: none;"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5>
                                                    ...
                                                    Featured: &nbsp;
                                                    <input type="radio" value="1" name="featured" required=""> ON / <input type="radio" value="1" name="featured"> OFF
                                                </h5>
                                                <img id="pic" style="width: 80%;margin: auto;"/>
                                                <input required="" type="file"  accept="imgs/*" id="file"name="img" onchange="loadFile(event)"
