 ...
 * @author Admin
 */
@WebServlet(name = "ProjectDetailServlet", urlPatterns = {"/projectDetail"})
public class ProjectDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Project project = prjDao.getProjectByProjectId(id);
        List<Account> listRsc = prjDao.getResource(id);
        
        session.setAttribute("project", project);
        session.setAttribute("listRsc", listRsc);
