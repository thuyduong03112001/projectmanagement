 ...
 * @author HP
 */
@WebServlet(name = "AddRiskServlet", urlPatterns = {"/addR"})
public class AddRiskServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddRiskServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddRiskServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            Risk risk = new Risk(name,title,cateID,createdBy,owner,description,cause,poss,impact,rank,status,update);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            RiskResponse RS = new RiskResponse(1,id,action,from,to,newP,newI);
            RiskDAO dao = new RiskDAO();
            dao.insertR(RS);
            String indexPage = request.getParameter("index");
            if (indexPage == null) {
